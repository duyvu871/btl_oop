...
class FakeRepository {
    private val recipes = listOf(
        Recipe(
            "1",
            "mon abc",
            "https://www.themealdb.com/images/media/meals/0206h11699763370.jpg",

        ),
        Recipe(
            "2",
            "mon def",
            "https://www.themealdb.com/images/media/meals/zqtyb01683207564.jpg",

        ),
        Recipe(
            "3",
            "mon ijk",
            "https://www.themealdb.com/images/media/meals/hqaebe1683209870.jpg",
